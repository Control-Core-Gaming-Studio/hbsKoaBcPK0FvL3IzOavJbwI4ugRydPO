...
var ASM_CONSTS = {
  9679552: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 9679607: ($0) => { performance.now = function() { return $0; }; },  
 9679655: ($0) => { performance.now = function() { return $0; }; },  
 9679703: () => { performance.now = Module['emscripten_get_now_backup']; }
};
...
// end include: preamble.js
  ...
  function _NotifyUnityReady() {
      window.alert("Unity is now ready!");
    }
...
var wasmImports = {
  ...
  "NotifyUnityReady": _NotifyUnityReady,
